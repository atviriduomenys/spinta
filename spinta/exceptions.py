...
class BackendNotGiven(UserError):
    template = "Model ({this}) is operating in external mode, yet it does not have assigned backend to it."
...
class DatasetSchemaRequiresIds(UserError):
    template = "All given schema ({this}) rows require UUID to be set in the id field."
