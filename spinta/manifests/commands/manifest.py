...
from spinta.components import Context, Model, Namespace, Node
from spinta.datasets.components import Dataset, Property, Resource
from spinta.exceptions import (
    DatasetNotFound,
    ManifestObjectNotDefined,
    ModelNotFound,
    NamespaceNotFound,
...
NODE_FUNCTION_MAPPER = {
    "model": _FunctionTypes(
        has=commands.has_model, get=commands.get_model, set=commands.set_model, get_all=commands.get_models
    ),
    "ns": _FunctionTypes(
    ...
    "dataset": _FunctionTypes(
        has=commands.has_dataset, get=commands.get_dataset, set=commands.set_dataset, get_all=commands.get_datasets
    ),
}
