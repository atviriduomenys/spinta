...
def test_inspect(
    ...
    # Configure Spinta.
    rc = configure(rc, None, tmp_path / 'manifest_text.csv', f'''
...
def test_inspect_from_manifest_table(
    ...
    cli.invoke(rc, [
        'inspect', tmp_path / 'manifest_text.csv',
...
def test_inspect_update_existing_manifest(
    ...
    # Configure Spinta.
    rc = configure(rc, sqlite, tmp_path / 'manifest_text.csv', f'''
