...
def test_get_subresource(model, app):
    app.authmodel(model, ["insert", "getone", "hidden_subobj_update", "hidden_subobj_getone"])
...
def test_put_subresource(model, app):
    app.authmodel(model, ["insert", "getone", "update", "subarray_update", "hidden_subobj_update"])
...
def test_patch_subresource(model, app):
    app.authmodel(
        model,
        ["insert", "getone", "patch", "subobj_patch", "subarray_patch", "hidden_subobj_patch", "hidden_subobj_update"],
    )
...
def test_get_subresource_file(model, app, tmp_path):
    app.authmodel(model, ["insert", "getone", "hidden_subobj_update", "pdf_update", "pdf_getone"])
...
def test_hidden_subresource_after_put(model, app):
    ...
    app.authmodel(model, ["insert", "update", "hidden_subobj_getone", "hidden_subobj_update"])
