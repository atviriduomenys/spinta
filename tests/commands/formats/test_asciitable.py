...
def test_export_asciitable(store, app, mocker):
    ...
    assert app.get('country/:source/csv/:changes/:format/asciitable').text == (
        ...
        f'{ids[1]}           {txn[0]}               025685077bbcf6e434a95b65b9a6f5fcef046861   2019-03-06 16:15:00.816308   insert   lv            LATVIA      \n'
        f'{ids[2]}           {txn[0]}               025685077bbcf6e434a95b65b9a6f5fcef046861   2019-03-06 16:15:00.816308   update   None          Latvia      '
    )
