...
def test_denorm_simple_level_4(
    ...
    app.authmodel('datasets/denorm/simple/in/Country', [
        'insert',
        'getall',
        'search'
    ])
    ...
    app.post('/datasets/denorm/simple/in/Country', json={
        '_id': lithuania_id,
        'id': 0,
        'name': 'Lithuania',
    })
    ...
    app.authmodel('datasets/denorm/simple/in/City', [
        'insert',
        'getall',
        'search'
    ])
    ...
    app.post('/datasets/denorm/simple/in/City', json={
        '_id': vilnius_id,
        'name': 'Vilnius',
        'country': {
            '_id': lithuania_id
...
def test_denorm_simple_level_3(
    ...
    app = create_test_client(context)
    app.authorize(['spinta_set_meta_fields'])
    app.authmodel('datasets/denorm/simple/ex/Country', [
        'insert',
        'getall',
        'search'
    ])
    lithuania_id = str(uuid.uuid4())
    latvia_id = str(uuid.uuid4())
    app.post('/datasets/denorm/simple/ex/Country', json={
        '_id': lithuania_id,
        'id': 0,
        'name': 'Lithuania',
    })
    ...
    app.authmodel('datasets/denorm/simple/ex/City', [
        'insert',
        'getall',
        'search'
    ])
    ...
    vilnius_id = str(uuid.uuid4())
    ryga_id = str(uuid.uuid4())
    app.post('/datasets/denorm/simple/ex/City', json={
        '_id': vilnius_id,
        'name': 'Vilnius',
        'country': {
            'id': 0
...
def test_denorm_simple_override_and_new_property(
    ...
    app = create_test_client(context)
    app.authorize(['spinta_set_meta_fields'])
    app.authmodel('datasets/denorm/simple/over/Country', [
        'insert',
        'getall',
        'search'
    ])
    lithuania_id = str(uuid.uuid4())
    latvia_id = str(uuid.uuid4())
    app.post('/datasets/denorm/simple/over/Country', json={
        '_id': lithuania_id,
        'id': 0,
        'name': 'Lithuania',
    })
    ...
    app.authmodel('datasets/denorm/simple/over/City', [
        'insert',
        'getall',
        'search'
    ])
    ...
    vilnius_id = str(uuid.uuid4())
    ryga_id = str(uuid.uuid4())
    app.post('/datasets/denorm/simple/over/City', json={
        '_id': vilnius_id,
        'name': 'Vilnius',
        'country': {
            '_id': lithuania_id,
...
def test_denorm_nested_level_4(
    ...
    app = create_test_client(context)
    app.authorize(['spinta_set_meta_fields'])
    app.authmodel('datasets/denorm/nested/in/Planet', [
        'insert',
        'getall',
        'search'
    ])
    ...
    app.post('/datasets/denorm/nested/in/Planet', json={
        '_id': earth_id,
        'id': 0,
        'name': 'Earth',
    })
    ...
    app.authmodel('datasets/denorm/nested/in/Country', [
        'insert',
        'getall',
        'search'
    ])
    ...
    lithuania_id = str(uuid.uuid4())
    latvia_id = str(uuid.uuid4())
    app.post('/datasets/denorm/nested/in/Country', json={
        '_id': lithuania_id,
        'id': 0,
        'name': 'Lithuania',
        'planet': {
    ...
    app.authmodel('datasets/denorm/nested/in/City', [
        'insert',
        'getall',
        'search'
    ])
    ...
    vilnius_id = str(uuid.uuid4())
    ryga_id = str(uuid.uuid4())
    app.post('/datasets/denorm/nested/in/City', json={
        '_id': vilnius_id,
        'name': 'Vilnius',
        'country': {
            '_id': lithuania_id
...
def test_denorm_nested_level_4_override(
    ...
    app = create_test_client(context)
    app.authorize(['spinta_set_meta_fields'])
    app.authmodel('datasets/denorm/nested/over/in/Planet', [
        'insert',
        'getall',
        'search'
    ])
    earth_id = str(uuid.uuid4())
    mars_id = str(uuid.uuid4())
    app.post('/datasets/denorm/nested/over/in/Planet', json={
        '_id': earth_id,
        'id': 0,
        'name': 'Earth',
    })
    ...
    app.authmodel('datasets/denorm/nested/over/in/Country', [
        'insert',
        'getall',
        'search'
    ])
    ...
    lithuania_id = str(uuid.uuid4())
    latvia_id = str(uuid.uuid4())
    app.post('/datasets/denorm/nested/over/in/Country', json={
        '_id': lithuania_id,
        'id': 0,
        'name': 'Lithuania',
        'planet': {
    ...
    app.authmodel('datasets/denorm/nested/over/in/City', [
        'insert',
        'getall',
        'search'
    ])
    ...
    vilnius_id = str(uuid.uuid4())
    ryga_id = str(uuid.uuid4())
    app.post('/datasets/denorm/nested/over/in/City', json={
        '_id': vilnius_id,
        'name': 'Vilnius',
        'country': {
            '_id': lithuania_id
...
def test_denorm_nested_level_3(
    ...
    app = create_test_client(context)
    app.authorize(['spinta_set_meta_fields'])
    app.authmodel('datasets/denorm/nested/ex/Planet', [
        'insert',
        'getall',
        'search'
    ])
    earth_id = str(uuid.uuid4())
    mars_id = str(uuid.uuid4())
    app.post('/datasets/denorm/nested/ex/Planet', json={
        '_id': earth_id,
        'id': 0,
        'name': 'Earth',
    })
    ...
    app.authmodel('datasets/denorm/nested/ex/Country', [
        'insert',
        'getall',
        'search'
    ])
    ...
    lithuania_id = str(uuid.uuid4())
    latvia_id = str(uuid.uuid4())
    app.post('/datasets/denorm/nested/ex/Country', json={
        '_id': lithuania_id,
        'id': 0,
        'name': 'Lithuania',
        'planet': {
    ...
    app.authmodel('datasets/denorm/nested/ex/City', [
        'insert',
        'getall',
        'search'
    ])
    ...
    vilnius_id = str(uuid.uuid4())
    ryga_id = str(uuid.uuid4())
    app.post('/datasets/denorm/nested/ex/City', json={
        '_id': vilnius_id,
        'name': 'Vilnius',
        'country': {
            'id': 0
...
def test_denorm_nested_level_3_multi(
    ...
    app = create_test_client(context)
    app.authorize(['spinta_set_meta_fields'])
    app.authmodel('datasets/denorm/nested/multi/Planet', [
        'insert',
        'getall',
        'search'
    ])
    earth_id = str(uuid.uuid4())
    mars_id = str(uuid.uuid4())
    app.post('/datasets/denorm/nested/multi/Planet', json={
        '_id': earth_id,
        'id': 0,
        'name': 'Earth',
        'code': 'ER',
    ...
    app.authmodel('datasets/denorm/nested/multi/Country', [
        'insert',
        'getall',
        'search'
    ])
    ...
    app.post('/datasets/denorm/nested/multi/Country', json={
        '_id': lithuania_id,
        'id': 0,
        'name': 'Lithuania',
        'planet': {
    ...
    app.authmodel('datasets/denorm/nested/multi/City', [
        'insert',
        'getall',
        'search'
    ])
    ...
    app.post('/datasets/denorm/nested/multi/City', json={
        '_id': vilnius_id,
        'name': 'Vilnius',
        'country': {
            'id': 0
...
def test_denorm_nested_advanced(
    ...
    app = create_test_client(context)
    app.authorize(['spinta_set_meta_fields'])
    app.authmodel('datasets/denorm/nested/adv/Planet', [
        'insert',
        'getall',
        'search'
    ])
    earth_id = str(uuid.uuid4())
    mars_id = str(uuid.uuid4())
    app.post('/datasets/denorm/nested/adv/Planet', json={
        '_id': earth_id,
        'id': 0,
        'name': 'Earth',
    })
    ...
    app.authmodel('datasets/denorm/nested/adv/Country', [
        'insert',
        'getall',
        'search'
    ])
    ...
    app.post('/datasets/denorm/nested/adv/Country', json={
        '_id': lithuania_id,
        'id': 0,
        'name': 'Lithuania',
        'planet': {
    ...
    app.authmodel('datasets/denorm/nested/adv/City', [
        'insert',
        'getall',
        'search'
    ])
    ...
    ryga_id = str(uuid.uuid4())
    talin_id = str(uuid.uuid4())
    app.post('/datasets/denorm/nested/adv/City', json={
        '_id': vilnius_id,
        'name': 'Vilnius',
        'country': {
            '_id': lithuania_id
...
def test_denorm_nested_override_and_new_property(
    ...
    app = create_test_client(context)
    app.authorize(['spinta_set_meta_fields'])
    app.authmodel('datasets/denorm/nested/over/Planet', [
        'insert',
        'getall',
        'search'
    ])
    earth_id = str(uuid.uuid4())
    mars_id = str(uuid.uuid4())
    app.post('/datasets/denorm/nested/over/Planet', json={
        '_id': earth_id,
        'id': 0,
        'name': 'Earth',
    })
    ...
    app.authmodel('datasets/denorm/nested/over/Country', [
        'insert',
        'getall',
        'search'
    ])
    ...
    lithuania_id = str(uuid.uuid4())
    latvia_id = str(uuid.uuid4())
    app.post('/datasets/denorm/nested/over/Country', json={
        '_id': lithuania_id,
        'id': 0,
        'name': 'Lithuania',
        'planet': {
    ...
    app.authmodel('datasets/denorm/nested/over/City', [
        'insert',
        'getall',
        'search'
    ])
    ...
    vilnius_id = str(uuid.uuid4())
    ryga_id = str(uuid.uuid4())
    app.post('/datasets/denorm/nested/over/City', json={
        '_id': vilnius_id,
        'name': 'Vilnius',
        'country': {
            'id': 0
