...
def _create_file(
    app, model: str, *, name: str = "data.txt", ctype: str = "text/plain", body: bytes = b"DATA", status: int = 201
):
...
@pytest.mark.parametrize("filename", ["../../passwd", "/tmp/etc/passwd"])
