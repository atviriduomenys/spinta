...
def test_json_text(
    ...
    pushdata(app, f'/example/json/text/Country', {
        'id': 0,
        'name': {
            'lt': 'Lietuva',
            'en': 'Lithuania',
...
def test_json_changes_text(
    ...
    pushdata(app, f'/example/json/text/changes/Country', {
        'id': 0,
        'name': {
            'lt': 'Lietuva',
            'en': 'Lithuania',
    ...
    resp = app.get("/example/json/text/changes/Country/:changes/-10/:format/json?select(id,name)", headers=Headers(headers={
        'accept-language': 'lt'
    })).json()['_data']
...
def test_json_changes_corrupt_data(
    ...
    pushdata(app, f'/example/json/changes/corrupt/Country', {
        '_id': country_id,
        'id': 0,
        'name': 'Lietuva'
    })
    pushdata(app, f'/example/json/changes/corrupt/City', {
        '_id': city_id,
        'id': 0,
        'name': 'Vilnius',
        'country': {
