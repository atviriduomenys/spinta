...
def test_ascii_changes_text(
    ...
    pushdata(app, f'/example/ascii/text/changes/Country', {
        'id': 0,
        'name': {
            'lt': 'Lietuva',
            'en': 'Lithuania',
    ...
    resp = app.get("/example/ascii/text/changes/Country/:changes/-10/:format/ascii?select(id,name)", headers=Headers(headers={
        'accept-language': 'lt'
    })).text
...
def test_ascii_changes_corrupt_data(
    ...
    pushdata(app, f'/example/ascii/changes/corrupt/Country', {
        '_id': country_id,
        'id': 0,
        'name': 'Lietuva'
    })
    pushdata(app, f'/example/ascii/changes/corrupt/City', {
        '_id': city_id,
        'id': 0,
        'name': 'Vilnius',
        'country': {
    ...
    resp = app.get("/example/ascii/changes/corrupt/City/:changes/-10/:format/ascii?select(_id, id, name, country, obj)").text
    assert resp == (
        '------------------------------------  --  -------  ------------------------------------  ------------  --------\n'
