...
class TestBase64Decode:
    def test_decode_base64(self, rc: RawConfig):
        ...
        assert env.call("base64_decode", asttoexpr(parse("base64_decode()"))) == "test"
    ...
    def test_raise_error_if_cannot_decode_base64(self, rc: RawConfig):
        ...
        with pytest.raises(InvalidBase64String):
            env.call("base64_decode", asttoexpr(parse("base64_decode()")))
