...
def test_migrate_adjust_ref_levels_with_denorm(
    ...
    with sa.create_engine(postgresql_migration).connect() as conn:
        ...
        table = tables['migrate/example/Ref']
        columns = table.columns
        assert {'someText', '__someRef._id', 'someRef.someText', 'someRef.someNumber', 'someRef.id', 'someRef.text'}.issubset(columns.keys())
    ...
    with sa.create_engine(postgresql_migration).connect() as conn:
        ...
        table = tables['migrate/example/Ref']
        columns = table.columns
        assert {'someText', '__someRef._id', 'someRef._id', '__someRef.someText', '__someRef.someNumber', 'someRef.id', 'someRef.text'}.issubset(
            columns.keys())
...
@pytest.mark.skip("Ref nesting not implemented")
