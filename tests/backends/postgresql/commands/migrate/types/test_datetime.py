...
from tests.backends.postgresql.commands.migrate.test_migrations import configure_migrate, cleanup_tables, \
    override_manifest, cleanup_table_list


def test_migrate_date_to_datetime(
...
def test_migrate_date_to_time_error(
    postgresql_migration: URL,
    rc: RawConfig,
    cli: SpintaCliRunner,
    tmp_path: Path
...
def test_migrate_datetime_to_date(
    postgresql_migration: URL,
    rc: RawConfig,
    cli: SpintaCliRunner,
    tmp_path: Path
...
def test_migrate_datetime_to_time(
    postgresql_migration: URL,
    rc: RawConfig,
    cli: SpintaCliRunner,
    tmp_path: Path
...
def test_migrate_time_to_date_error(
    postgresql_migration: URL,
    rc: RawConfig,
    cli: SpintaCliRunner,
    tmp_path: Path
...
def test_migrate_time_to_datetime_error(
    postgresql_migration: URL,
    rc: RawConfig,
    cli: SpintaCliRunner,
    tmp_path: Path
